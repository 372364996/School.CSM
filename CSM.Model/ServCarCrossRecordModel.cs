...
namespace CSM.Model
{
	 ...
	 public class ServCarCrossRecordModel
	{
		...
		/// tollgatecode
        /// </summary>		
        public string tollgatecode{set;get;}      
		/// <summary>
		/// cross_time
        /// </summary>		
        public DateTime cross_time{set;get;}      
		/// <summary>
		/// car_image
        /// </summary>		
        public string car_image{set;get;}      
		/// <summary>
		/// car_speed
        /// </summary>		
        public int car_speed{set;get;}      
		/// <summary>
		/// 无违章：-1
       /// 违章：与Base_Car_AlarmType表关联
        /// </summary>		
