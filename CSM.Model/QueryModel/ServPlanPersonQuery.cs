...
namespace CSM.Model.QueryModel
{
	 	//通知责任人的表，不是网格负责人的表
   //网格负责人直接在勾选后的处置项
	 public class ServPlanPersonQuery
	{
		...
		/// plan_id
        /// </summary>		
        public int handleitem_id { set;get;}      
		/// <summary>
		/// 设备预案：1
       //事件预案：2
        /// </summary>		
		...
		/// person_phone_num
        /// </summary>		
        public string person_phone_num{set;get;}      
		/// <summary>
		/// 此处为ssoid
        /// </summary>		
       ...
       /// 否：0
        /// </summary>		
        public int is_call{set;get;}      
		/// <summary>
		/// 是：1
        ///否：0
        /// </summary>		
        public int is_message{set;get;}      
		/// <summary>
		/// ext1
        /// </summary>		
