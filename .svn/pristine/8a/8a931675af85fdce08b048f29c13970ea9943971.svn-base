...
{
   public  class RetCameraPatrolSchedule
    {
        /// <summary>
        /// 主键
        /// </summary>
        ...
        /// 执行开始时间
        /// </summary>
        public string start_execute_time { get; set; }
        /// <summary>
        /// 执行结束时间
        /// </summary>
        public string end_execute_time { get; set; }
        /// <summary>
        /// 执行周期表达式
        /// </summary>
        public string period_expression { get; set; }
        /// <summary>
        /// 执行时间间隔（分钟）
        /// </summary>
        ...
        /// corn时间表达式model
        /// </summary>
        public ShowCronTimeModel cronTime { get; set; }
